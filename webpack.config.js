  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        ...
        "./data/H3": "./shared/data_display/Heading/H3",
        "./data/H4": "./shared/data_display/Heading/H4",
        "./data/H5": "./shared/data_display/Heading/H5",
        "./data/H6": "./shared/data_display/Heading/H6",
